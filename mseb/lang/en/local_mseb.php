...
$string['js:desktop_mode'] = 'Desktop Mode Detected! Please turn off "Desktop Site" in your browser settings or use the M-SEB app.';
$string['js:is_mobile_blocked'] = 'Mobile Device Detected! Please use the M-SEB app.';
...
$string['mseb_enabled_desc'] = 'Enforce the use of the M-SEB (Android) app or block regular browsers. If active, desktop mode will also be blocked.';
...
$string['mseb_facerecognition'] = 'ENABLE FACE RECOGNITION';
$string['mseb_facerecognition_desc'] = 'Require students to stay in front of the camera. If not detected, a warning and violation will be triggered (Android App only).';
$string['mseb_navsafetimeout'] = 'NAV SAFE TIMEOUT (SECONDS)';
$string['mseb_navsafetimeout_help'] = 'How long the safety status stays active after clicking a navigation button. High values (e.g., 60s) are safer for slow connections/servers.';

...
$string['mseb_facerecognition'] = 'AKTIFKAN PENGAWASAN KAMERA';
$string['mseb_facerecognition_desc'] = 'Wajibkan siswa berada di depan kamera. Jika tidak terdeteksi, peringatan dan pelanggaran akan dilakukan (Hanya Aplikasi Android).';
...
$string['mseb_navsafetimeout'] = 'NAV SAFE TIMEOUT (DETIK)';
$string['mseb_navsafetimeout_help'] = 'Lama waktu toleransi saat berpindah soal atau memuat gambar (Default 60 detik). Diatur otomatis minimal 120 detik jika koneksi lambat.';
